...
local caching, and event creation. Route prefix is added by the plugin
loader — this router has no prefix of its own.

Used by the calendar plugin __init__.py — call init(calendar_db, core_db)
at load time.
"""
...
# Set during plugin init
cal_db: CalendarDatabase | None = None
main_db = None  # core Database instance — provides get_setting / set_setting

# Google API scopes — read+write events
SCOPES = ["https://www.googleapis.com/auth/calendar"]


def init(calendar_db: CalendarDatabase, db) -> None:
    """Called by the calendar plugin on load to inject dependencies."""
