"""LLM tool definitions for task management.

Registers task CRUD operations as tools that LLMs can call during
...
from .urgency import parse_date, sort_by_urgency
